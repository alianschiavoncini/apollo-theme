...
<div class="main-content">
    ...
    <div class="page-header" <?php echo $style_bg; ?>>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'apollo-hotel' ); ?></h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <article id="post-404notfound">
                        ...
                        <p><?php  esc_html_e( 'It looks like nothing was found at this location. Maybe try a search?', 'apollo-hotel' ); ?></p>
                        <?php get_search_form(); ?>
                        </div>
                    </article>
                </div>
