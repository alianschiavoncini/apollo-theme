    ...
    <div id="carouselhome" class="carousel slide" data-ride="carouselhome" data-interval="5000">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div id="carouselhome-slide-<?php echo $n; ?>" class="carousel-item<?php if ( $n == 1 ) { echo ' active'; } ?>">
              ...
              <picture>
                <source srcset="<?php echo $item['img_lg']; ?>" media="(min-width: 1400px)"> <!-- apollo-hotel-slideshow-lg -->
                <source srcset="<?php echo $item['img_md']; ?>" media="(min-width: 769px)"> <!-- apollo-hotel-slideshow-md -->
                <source srcset="<?php echo $item['img_sm']; ?>" media="(min-width: 577px)"> <!-- apollo-hotel-slideshow-sm -->
      ...
      <a class="carousel-control-prev" href="#carouselhome" role="button" data-slide="prev">
        ...
        <span class="sr-only"><?php esc_html_e( 'Previous', 'apollo-hotel' ); ?></span>
      </a>
      <a class="carousel-control-next" href="#carouselhome" role="button" data-slide="next"> 
        <span class="carousel-control-next-icon fa fa-angle-right" aria-hidden="true"></span> 
        <span class="sr-only"><?php esc_html_e( 'Next', 'apollo-hotel' ); ?></span> 
      </a>
      <?php } ?>
